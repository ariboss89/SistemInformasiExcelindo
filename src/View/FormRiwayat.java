...
public class FormRiwayat extends javax.swing.JFrame {
    ...
    String[] namaKolom = {"Id Transaksi", "Tanggal", "Jumlah", "Total", "Bayar","Kembalian","Pelanggan"};
    int jmlKolom = namaKolom.length;
    int[] lebar = {200, 400, 400, 400, 400, 400, 400,400};
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtTotal.setText(jTable1.getValueAt(row, 3).toString());
        txtBayar.setText(jTable1.getValueAt(row, 4).toString());
        txtKembalian.setText(jTable1.getValueAt(row, 5).toString());
        rwt.setPelanggan(jTable1.getValueAt(row, 6).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            parameter.put("totalbayar", total);
